            ...
            <section className="section border-t-[6px] border-t-violet-quaternary">
                <div className="container">
                    ...
                    <header>
                        ...
                        <div>
                            <p>
                                Присоединяйтесь к нашему успешному сообществу,
                                где более 300 партнеров уже нашли свое место!
                            </p>
                            <p>
                                Мы сотрудничаем с партнерами со всех уголков
                                мира, создавая уникальные возможности для
                                заработка. Присоединяйтесь к нам сегодня и
                ...
                <div className="container">
                    <figure>
                        ...
                        >
                            ...
                            <g clip-path="url(#clip1_2087_687)">
                                <path
                    ...
                    <header>
                        <h2>Гарантированные выплаты</h2>

                        <div>
                            <p>Наша прозрачность - ваша уверенность!</p>
                            <p>
                                Мы с гордостью объявляем, что уже выплатили
                                более 100 000$ нашим преданным партнерам.
                            </p>
                            <p>
                                Это доказательство нашей надежности и того, что
                                мы ценим каждого нашего участника.
                            </p>
                            <p>
                                Присоединяйтесь к нашей успешной команде и
                                станьте частью нашего процветающего сообщества.
                                Ваши финансовые цели - наш приоритет!
                            </p>
                        </div>
                    </header>
                </div>
                ...
                <div className="container">
                    <div className="order-2">
                        <header>
                            ...
                            <div>
                                <p>
                                    Время действовать! Будь нашим партнером и
                                    начните превращать возможности в стабильный
                                    доход. Мы предлагаем прозрачные условия,
                                    надежную поддержку и неограниченный
                                    потенциал!
                                </p>
                            </div>
                        </header>
